...
export const DEFAULT_SETTINGS: Settings = {
  ...
  numberResetSelector: '',
  scope: '',
  contentTemplate: `<aside class="tinyfoot__popover" id="fncontent:<% id %>"><div class="${CLASS_WRAPPER}"><div class="${CLASS_CONTENT}"><% content %></div></div><div class="${CLASS_TOOLTIP}"></div></aside>`,
